...
qq.FileUploaderBasic.prototype = {
    ...
    _uploadFile: function(fileContainer){      
        ...
        if (this._options.onSubmit(id, fileName) !== false){
            ...
            cancelList = document.getElementsByClassName('qq-upload-cancel');
            submit = submitList[submitList.length-1];
            cancel = cancelList[cancelList.length-1];
            var accept_func = function(){
                parent = this.parentNode.parentNode;
                if (!globalOwner._options.title_require ||
                    parent.getElementsByClassName('qq-image-name')[0].value != '')
                {
            ...
            if (globalOwner._options.title_require)
            {
                submit.addEventListener('click', accept_func);
            }
            else
            {
                accept_func.call(cancel);
            }
...
qq.FileUploader = function(o){
    ...
    this._options.fileTemplateNoTitle = this._options.fileTemplateNoTitle.replace(/\{cancelButtonText\}/g, this._options.cancelButtonText);
    this._options.fileTemplateNoTitle = this._options.fileTemplateNoTitle.replace(/\{failUploadtext\}/g, this._options.failUploadText);
    this._options.fileTemplateNoTitle = this._options.fileTemplateNoTitle.replace(/\{nameSubmit\}/g, this._options.nameSubmit);
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName, params){
        var item =  this._options.title_require ?
            qq.toElement(this._options.fileTemplate)
            : qq.toElement(this._options.fileTemplateNoTitle);
        item.qqFileId = id;
